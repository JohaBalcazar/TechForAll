   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            ...
            <h3>La mejor calidad en notebooks</h3>
...
?>
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <div class="flex">
         <div class="price"><span>GS.</span><?= $fetch_product['price']; ?></div>
   ...
   <?php
      ...
      echo '<p class="¡Aún no se han añadido productos!</p>';
   }
   ?>
