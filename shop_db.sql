...
------------------------------------------------------------------
ALTER TABLE `users`
ADD `role` ENUM('comprador', 'vendedor') NOT NULL DEFAULT 'comprador';
...
ALTER TABLE `products`
ADD FOREIGN KEY (`vendedor_id`) REFERENCES `users`(`id`) ON DELETE CASCADE;
ALTER TABLE `users`
MODIFY `role` ENUM('comprador', 'vendedor', 'admin') NOT NULL DEFAULT 'comprador';

ALTER TABLE products
ADD CONSTRAINT fk_vendedor FOREIGN KEY (vendedor_id) REFERENCES users(id) ON DELETE CASCADE;
