<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="shop.php"> <i class="fas fa-angle-right"></i> Comercio</a>
         <a href="contact.php"> <i class="fas fa-angle-right"></i> Contacto</a>
      </div>

      <div class="box">
         <h3>Enlaces adicionales</h3>
         <a href="user_login.php"> <i class="fas fa-angle-right"></i> Inicio sesión</a>
      ...
      <div class="box">
         <h3>Contact Us.</h3>
         <a href="tel:9800000000"><i class="fas fa-phone"></i> 0983321263</a>
         <a href="tel:9900000000"><i class="fas fa-phone"></i> 0981321456</a>
         <a href="mailto:harshchy143@gmail.com"><i class="fas fa-envelope"></i> techforall@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Asunción, Paraguay </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>TechForAll</span> |reservados todos los derechos!</div>
